...
class _PostPagerState extends State<PostPager> {
  ...
  Widget build(BuildContext context) {
    return Consumer<PhotosNotifier>(
      builder: (context, photoNotifier, child) {
        return Transform.scale(
          ...
          child: PageView.builder(
                    ...
                    onTap: () {
                      Navigator.of(context).push(PageRouteBuilder(
                          ...
                          pageBuilder: (_, __, ___) =>
                              DetailPage(photoNotifier.photos[index])
                      ));
                    },
                    child: Hero(
                      tag: photoNotifier.photos[index].urls.regular,
                      child: Poster(
                        scale: scale,
                        img: photoNotifier.photos[index].urls.regular,
                      ),
                    ),
                  );
                },
            ...
            itemCount: photoNotifier.photos.length,
          ),
        );
      },
    );

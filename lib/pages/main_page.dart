  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider<PhotosNotifier>.value(value: photosNotifier),
      ],
      child: ChangeNotifierProvider<PhotosNotifier>.value(
        ...
        child: Scaffold(
          ...
          body: SafeArea(
            child: Container(
              ...
              child: Consumer2<PhotosNotifier, PageNotifier>(
                builder: (context, photosNotifier, pageNotifier, child) {
                  if (photosNotifier.photos.isEmpty) {
                    return Center(child: CircularProgressIndicator());
                  }
                  PhotoResponse photoResponse =
                    photosNotifier.photos[pageNotifier.value.floor()];
                  return Stack(
                    children: <Widget>[
                      Positioned(
                        top: searchTop,
                      ...
                      Positioned(
                        top: ratingTop,
                        left: side_gap,
                        child: Rating(photoResponse.likes), //voteAverage
                      ),
                      Positioned(
                          top: titleTop,
                          left: side_gap,
                          child: MovieTitle(photoResponse.user.username)), //originalTitle
